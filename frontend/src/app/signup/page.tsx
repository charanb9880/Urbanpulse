...
export default function SignupPage() {
  ...
  const [mode, setMode] = useState<ModeState>('form');
            ...
            {mode === 'success' && (
              ...
              >
                ...
                <p className="text-slate-500 mb-8 max-w-xs mx-auto">
                  Creating your account and initializing dashboard environment...
                </p>
              </motion.div>
            )}
            ...
            {mode === 'form' && (
              ...
              >
                ...
                <div>
                  ...
                  <p className="text-slate-500 mt-2">Join UrbanPulse AI today and improve city mobility.</p>
                </div>
                      ...
                      {rolesList.map((r) => (
                        <button
                          ...
                          className={`px-4 py-3 rounded-xl border text-sm font-semibold transition-all ${
                            role === r.value
                              ? "bg-gradient-to-r from-indigo-500/10 to-purple-500/10 border-indigo-500 text-indigo-600"
                              : "bg-slate-50 border-slate-200/60 text-slate-700 hover:border-slate-300"
                          }`}
                        >
                          {r.label}
                        </button>
